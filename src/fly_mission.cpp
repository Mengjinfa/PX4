...
static std::vector<mavsdk::Mission::MissionItem> create_custom_waypoints()
{
    ...
    // 航点1
    mission_items.push_back(make_mission_item(47.3977508, 8.5460807, 10.0f, 15.0f, 90, false));

    // 航点2
    mission_items.push_back(make_mission_item(47.3977508, 8.5474807, 5.0f, 1.0f, 90, true));
