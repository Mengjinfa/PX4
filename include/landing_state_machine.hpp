...
public:
    ...
    void StartStateMachine(mavsdk::Telemetry::PositionNed current_position, double current_altitude, double current_yaw); // 启动状态机
...
private:
    ...
    float m_current_yaw_deg;                           // 当前偏航角度(度)
